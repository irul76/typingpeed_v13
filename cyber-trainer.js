...
// ================================================================
// INJECT PAGE HTML — jalankan setelah DOM siap
// ================================================================
function injectCyberPage() {
  if (document.getElementById('page-cybertrainer')) return; // sudah ada, skip

  const main = document.querySelector('.main');
  if (!main) {
    console.error('CyberTrainer: .main not found — pastikan index.html punya .main');
    return;
  }
