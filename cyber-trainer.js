...
(function injectCyberPage() {
  ...
  if (document.getElementById('page-cybertrainer')) return;
...
// Pastikan cyInit tidak crash jika dipanggil sebelum DOM siap
window._cyReady = false;
document.addEventListener('DOMContentLoaded', () => {
  window._cyReady = true;
  // Inject char styles yang dibutuhkan typing display
  ...
  // Jika halaman cybertrainer sudah active saat load (misal direct link)
